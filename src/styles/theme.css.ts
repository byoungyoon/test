...
export const blogRankGrid: { [key: string]: string } = {
  [JISOO.HIGH]: style([
    blogRank,
    {
      backgroundColor: '#edb104',
    },
  ]),
  [JISOO.BEST]: style([
    blogRank,
    {
      backgroundColor: '#2cd164',
    },
  ]),
  [JISOO.NORMAL]: style([
    blogRank,
    {
      backgroundColor: '#d43712',
    },
  ]),
};
...
const nanumGothic = {
  regular: fontFace({
    src: "url('/fonts/NanumGothic/NanumGothic.woff') format('woff'), url('/fonts/NanumGothic/NanumGothic.eot') format('eot')",
    fontWeight: 400,
    fontStyle: 'normal',
  }),

  bold: fontFace({
    src: "url('/fonts/NanumGothic/NanumGothicBold.woff') format('woff'), url('/fonts/NanumGothic/NanumGothicBold.eot') format('eot')",
    fontWeight: 700,
    fontStyle: 'normal',
  }),

  extraBold: fontFace({
    src: "url('/fonts/NanumGothic/NanumGothicExtraBold.woff') format('woff'), url('/fonts/NanumGothic/NanumGothicExtraBold.eot') format('eot')",
    fontWeight: 800,
    fontStyle: 'normal',
  }),
};
